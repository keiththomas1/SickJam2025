...
namespace KinematicCharacterController.Examples
{
    public class ExampleMovingPlatform : MonoBehaviour, IMoverController
    {
        ...
        public float TranslationTimeOffset = 0f;
        ...
        {
            goalPosition = (_originalPosition + (TranslationAxis.normalized * Mathf.Sin((Time.time + TranslationTimeOffset) * TranslationSpeed) * TranslationPeriod));
